        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-[#6D0D0D] rounded-full flex items-center justify-center hover:bg-[#D71920] transition-all duration-300 transform hover:scale-110">
